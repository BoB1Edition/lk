...
SECRET_KEY = '6d(@fdco)42596%h%icsbv9&3qu1ved=ree)-q*mb5huay$wc8'
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'read_default_file': os.path.join(BASE_DIR, 'lk.cnf'),
        },
    },
    'asterisk': {
        'ENGINE': 'django.db.backends.mysql',
        'OPTIONS': {
            'read_default_file': os.path.join(BASE_DIR, 'asterisk.cnf'),
        },
    },
    'asteriskcdrdb': {
        'ENGINE': 'django.db.backends.mysql',
